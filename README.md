...
This project demonstrates the implementation of a Library Management System using SQL, built on a PostgreSQL database. It includes creating database with DDL queries, establishing relationships between tables, inserting first records into tables, performing another CRUD operations and executing more advanced SQL queries like CTE. It showcases skills in database design, manipulation and querying.
